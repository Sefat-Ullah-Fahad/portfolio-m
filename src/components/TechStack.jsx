...
export default function TechStack() {
  ...
  return (
    <section ref={sectionRef} id="stack" className="relative w-full min-h-screen bg-[#030108] text-white py-24 px-4 md:px-8 overflow-hidden z-10 flex flex-col justify-center scroll-mt-28">
